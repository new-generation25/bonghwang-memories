...
export const YEAR_KEYS = [
  ...
  ["gb", "일반(무료) 상점 수 (곳)", 15, 48, 90],
  ["gp", "프리미엄 상점 수 (곳)", 7, 24, 45],
  ["gs", "스토리 파트너 수 (곳)", 3, 8, 15],
  ["tpd", "거점당 하루 진입 팀 (팀)", 3.1, 3.6, 3.8],
  ["cv", "결제 전환율", 0.08, 0.1, 0.12],
  ["mix", "2단 비중", 0.3, 0.4, 0.5],
  ["ku", "3단 업셀률", 0.04, 0.04, 0.04],
  ["cov", "상점 충당률", 0, 0.6, 0.85],
