...
export const CUES: Record<CueId, Cue> = {
  ...
  B0_TAPE: {
    ...
    subtitleLines: [
      ...
      // 이름은 따로 세운다 — 딸에게 처음 불러보는 이름이라 앞말에 묻히면 안 된다
      { text: '강소영. 아빠가 지었다.' },
      { text: '이런 거 왜 하나 싶다마는.<br>아빠가 원래 말주변이 없다.<br>그러니까 여기다 해두는 거다.' },
      { text: '너 기다리면서… 뭐, 소원이랄 것까진 없고.<br>다섯 개 정해봤다.' },
      // 소원 다섯 개는 한 줄씩 센다 — 하나하나 꼽아 세는 말투라 붙여 읽으면 목록이 된다
      { text: '하나, 엄마랑 어떻게 만났는지 들려주기.<br>' },
      { text: '둘. 목욕탕 가서 서로 등 밀어주기.' },
      { text: '셋, 예쁜 사진 찍어주기.' },
      { text: '넷, 좋아하는 음악 같이 듣기.' },
      { text: '다섯… 가족오락관 같이 나가기.' },
      { text: '네가 크면 같이 듣자. 몇 개나 지켰나 세어보고.' },
      { text: '뭐, 그런 약속이다.' },
      { text: '얼른 만나고 싶구나.' },
    ],
  ...
  B0_CALL: {
    ...
    subtitleLines: [
      ...
      { text: '소원들이 전부 이 동네 어딘가에 있어요.<br>근데 저는 아버지 옆에 있어야 해서 나갈 수가 없어요.' },
  ...
  */
  ...
  B2_A: {
    ...
    subtitleLines: [
      ...
      { text: '아들 기대하면서 정한 소원이었는데, 태어난 건 딸이라…<br>일곱 살까지밖에 같이 못 갔대.<br>내가 커버렸으니까.' },
      { text: '그래서 아빠는 목욕탕 못 가는 대신,<br>매주 일요일마다 그 가게에서 바나나우유를 사 왔어.' },
      { text: "나 그게 그냥 바나나우유인 줄 알았어.<br>그게 '목욕탕 대신'이었다는 걸, 이번에 내려와서 이제야 알았네." },
      { text: '근데 생각해보니까, 이 소원은 이제 아무도 못 이뤄.<br>나는 다 컸고, 아빠는 다리에 깁스를 했고.' },
  ...
  B2_B: {
    ...
    subtitleLines: [
      ...
      { text: '아빠는 말로 사랑한다고 한 적이 없어.<br>근데 이런 걸로 다 했던 거였네.' },
      { text: '나는… 아빠가 나한테 관심이 없는 줄 알았어.<br>서운해할 줄만 알았지, 19년 동안.' },
      { text: '괜찮아, 나 안 울어. 가자.<br>그 골목 끝에 오래된 한옥이 하나 있어.' },
  ...
  B3_A: {
    ...
    subtitleLines: [
      ...
      { text: '나 그때 사춘기라고 싫다고 했어.<br>그러고 못 찍었어.<br>그 약속만 남고, 사진은 없어.' },
  ...
  B3_B: {
    ...
    subtitleLines: [
      { text: '…와, 예쁘다. 진짜 피었네.' },
      { speaker: '소영(혼잣말)', text: '아빠, 봤어요? 우리가 여기서 사진 찍었어요.<br>늦었지만… 약속 지켰어요.' },
      { text: "네 번째 소원이 문제야.<br>'좋아하는 음악 같이 듣기'인데…<br>아빠가 무슨 음악을 좋아했는지, 나 모르겠어." },
      { text: '밤마다 라디오를 들으셨던 건 기억나는데.' },
      { text: '저기, 그 테이프… 소원 뒤에 뭐가 더 있는지 볼래?<br>아빠가 뭘 남겼을지도 몰라.<br>나는 아빠의 소원까지만 돌려봤거든.' },
      { text: '찾기 어려울 텐데, 저 앞에 오른쪽으로 좁은 골목 있지?<br>거기로 들어가면 카페 탱자가 있어.' },
  ...
  B4_RADIO: {
    ...
    subtitleLines: [
      ...
      { speaker: '아버지', text: "근데 제가 말재주가 없어서,<br>'아빠가 너를 사랑한다' 이 한마디를 제대로 못 해봤습니다." },
      { speaker: '아버지', text: '우리 딸, 영원히 지금처럼 웃는 소녀로 남았으면 합니다.' },
      { speaker: '아버지', text: '소영아.<br>… 아빠는, 네가 웃을 때가 제일 행복하다.' },
    ],
    sfx: { in: 'tape_hiss' },
    next: 'B4_B',
  },
  ...
  B4_B: {
    ...
    subtitleLines: [
      ...
      { text: '…근데 너는, 혹시 지금 옆에 없는 사람 있어?<br>있으면, 휴대폰에라도 남겨봐.' },
  ...
  B5_A: {
    ...
    durationSec: 9,
    subtitleLines: [
      { text: '도착했어? 주변에 뭐 붙어 있는 거 없어?<br>포스터 같은 거.' },
  ...
  B5_T2: {
    ...
    durationSec: 21,
    subtitleLines: [
      { text: '혹시… 강민수 어르신 일로 오셨어요?<br>어르신이 한 달 전에 오셨어요.' },
  ...
  B5_F: {
    ...
    subtitleLines: [
      ...
      { text: '다음 주엔 아빠 휠체어 밀고 같이 나갈 거야.<br>마지막 소원은 우리가 직접 이룰게.' },
      { text: '오늘 처음 만났는데…<br>너, 이제 내 친구야. 진심으로.' },
    ],
    next: 'B6_0',
    /*
